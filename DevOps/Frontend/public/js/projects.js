...
const Projects = (() => {
  ...
  function categoryLabel(c) {
    return { web: 'Web', mobile: 'Mobile', api: 'API', aws: 'Cloud AWS', 'administration system': 'Admin System', AI: 'AI' }[c] || c;
  }
  function badgeClass(c) {
    return { web: 'badge-web', mobile: 'badge-mobile', api: 'badge-api', aws: 'badge-aws', 'administration system': 'badge-admin', AI: 'badge-ai' }[c] || 'badge-web';
  }
